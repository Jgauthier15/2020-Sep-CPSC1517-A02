...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row"><h1>Common Web Form Controls and using event driven logic</h1></div>
            ...
            <asp:TextBox ID="NumberChoice" runat="server"
                ...
                ToolTip="Enter a number between 1 and 4"></asp:TextBox>&nbsp;&nbsp;
                    <asp:Button ID="SubmitNumberChoice" runat="server"
                        Text="Submit Number Choice" CssClass="btn btn-sucess" />
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6 text-right">
            <asp:Label ID="Label2" runat="server"
                Text="Radio Buttons of choice"></asp:Label>&nbsp;
        </div>
        <div class="col-md-6">
