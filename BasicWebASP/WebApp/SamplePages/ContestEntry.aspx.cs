...
namespace WebApp.SamplePages
{
    public partial class ContestEntry : System.Web.UI.Page
    {
        ...
        //  to retain data, the following List<T> will serve as the page collection dataset
        //the List<T> is declare as static
        ...
        protected void Submit_Click(object sender, EventArgs e)
        {
            ...
            if (Terms.Checked)
            {
                ...
                //add the new instance to a colelction of entries
            ...
            {
                Message.Text = "You did not agree to the context terms. Entry rejected.";
            }
        }
