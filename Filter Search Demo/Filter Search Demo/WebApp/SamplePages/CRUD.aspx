<%@ Page Title="CRUD" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CRUD.aspx.cs"
    Inherits="WebApp.SamplePages.CRUD" %>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <table>
                ...
                <tr>
                    <td align="right">
                        <asp:Label ID="Label6" runat="server" Text="QoH"></asp:Label>
                    </td>
                    <td align="left">
                ...
                <tr>
                    <td align="right">
                        <asp:Label ID="Label9" runat="server" Text="QoO"></asp:Label>
                    </td>
                    <td align="left">
                ...
                <tr>
                    <td align="right">
                        <asp:Label ID="Label8" runat="server" Text="Disc."></asp:Label>
                    </td>
                    <td align="left">
